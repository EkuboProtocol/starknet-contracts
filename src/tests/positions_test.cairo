...
mod nft {
    ...
    fn test_deposit_liquidity_concentrated() {
        ...
        let balance0 = positions
            .clear(setup.token0.contract_address, contract_address_const::<2>());
        let balance1 = positions
            .clear(setup.token1.contract_address, contract_address_const::<2>());
    ...
    fn test_deposit_liquidity_concentrated_unbalanced_in_range_price_higher() {
        ...
        assert(
            setup.token0.balance_of(contract_address_const::<2>()) == u256 {
                low: 66674999, high: 0
            },
            'balance0 transfer'
        );
    ...
    fn test_deposit_liquidity_concentrated_unbalanced_in_range_price_lower() {
        ...
        assert(
            setup.token1.balance_of(contract_address_const::<2>()) == u256 {
                low: 66674999, high: 0
            },
            'balance1 transfer'
        );
